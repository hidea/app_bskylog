...
final class Schema3 extends i0.VersionedSchema {
  ...
  late final Shape1 posts = Shape1(
      source: i0.VersionedTable(
        entityName: 'posts',
        withoutRowId: false,
        isStrict: false,
...
class Shape1 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get post =>
      columnsByName['post']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<DateTime> get retrieved =>
      columnsByName['retrieved']! as i1.GeneratedColumn<DateTime>;
}
...
i1.GeneratedColumn<DateTime> _column_14(String aliasedName) =>
    i1.GeneratedColumn<DateTime>('retrieved', aliasedName, false,
        type: i1.DriftSqlType.dateTime,
